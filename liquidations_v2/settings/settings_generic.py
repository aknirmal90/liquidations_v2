"""
Django settings for liquidations_v2 project.
...
WSGI_APPLICATION = "liquidations_v2.wsgi.application"
...
REDIS_CACHE_LOCATION, REDIS_CACHE_DB = config("REDIS_APP_DB").rsplit("/", 1)
