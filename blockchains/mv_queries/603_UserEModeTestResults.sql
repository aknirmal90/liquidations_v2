-- Table to store user eMode validation test results
-- Compares ClickHouse data (EModeStatusDictionary) against RPC data from Pool contract

CREATE TABLE IF NOT EXISTS aave_ethereum.UserEModeTestResults
(
