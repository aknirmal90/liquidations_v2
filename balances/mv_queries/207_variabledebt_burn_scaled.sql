-- MV Query: Materialized View for Burn event (VariableDebt) with correct ray math scaling
...
-- where RAY = 1e27
CREATE MATERIALIZED VIEW IF NOT EXISTS aave_ethereum.mv_variabledebt_burn_scaled TO aave_ethereum.LatestBalances_v2
AS SELECT
    from as user,
    asset as asset,
