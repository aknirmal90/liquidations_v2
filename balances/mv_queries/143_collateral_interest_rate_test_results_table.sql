-- Table for storing collateral interest rate (currentLiquidityRate) test results
CREATE TABLE IF NOT EXISTS aave_ethereum.CollateralInterestRateTestResults
(
