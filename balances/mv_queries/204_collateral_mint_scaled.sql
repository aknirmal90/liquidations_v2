-- MV Query: Materialized View for Mint event (Collateral) with correct ray math scaling
...
-- where RAY = 1e27
CREATE MATERIALIZED VIEW IF NOT EXISTS aave_ethereum.mv_balances_mint_scaled TO aave_ethereum.LatestBalances_v2
AS SELECT
    onBehalfOf as user,
    asset as asset,
