...
AS SELECT
    asset,
    maxState(toString(collateral_liquidityIndex)) as max_collateral_liquidityIndex,
    maxState(toString(variable_debt_liquidityIndex)) as max_variable_debt_liquidityIndex,
